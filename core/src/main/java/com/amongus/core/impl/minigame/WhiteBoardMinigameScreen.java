...
public class WhiteBoardMinigameScreen extends AbstractMinigameScreen {
    ...
    private Pixmap regionToPixmap(TextureRegion region) {
        // Necesitamos leer la textura desde GPU → usar FrameBuffer
        ...
        com.badlogic.gdx.graphics.glutils.FrameBuffer fb =
            new com.badlogic.gdx.graphics.glutils.FrameBuffer(
                Pixmap.Format.RGBA8888, rw, rh, false);
        ...
        tmpBatch.begin();
        // Dibujar la región invertida verticalmente (Pixmap tiene Y al revés)
        ...
        Pixmap pm = com.badlogic.gdx.utils.ScreenUtils.getFrameBufferPixmap(0, 0, rw, rh);
        fb.end();
